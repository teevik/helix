...
impl MappableCommand {
    ...
    static_commands!(
        ...
        goto_label, "Jump to a two-character label",
        extend_to_label, "Extend to a two-character label",
    );
}
...
fn goto_label(cx: &mut Context) {
    jump_to_word(cx, false)
}

fn extend_to_label(cx: &mut Context) {
    jump_to_word(cx, true)
}

fn jump_to(cx: &mut Context, labels: Vec<Range>, extend: bool) {
...
fn jump_to_word(cx: &mut Context, extend: bool) {
